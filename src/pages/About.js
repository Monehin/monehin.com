...
const About = () => {
  return (
    <section className='w-full h-screen flex'>
      <div className='about-title h-full flex w-1/2 justify-center items-center font-extrabold text-4xl '>
        About Me
      </div>
